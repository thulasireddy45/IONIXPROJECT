<div class="bg-img">
<h1 align=center>PUBLIC ROAD TRANSPORT SYSTEM</h1>
  
  <form onsubmit="return a()" method="POST" class="box container"  action="login1.php">
    ...
    <input type="text" id="t3" placeholder="Enter Email" name="email" required>
    <label for="username"><b>Username</b></label>
    <input type="text" id="t4" placeholder="user name" name="username" required>

    <label for="psw"><b>New Password</b></label>
    <input type="password" id="t1" placeholder="New Password" name="psw" required>
	

    <label for="psw1"><b>Confirm New Password</b></label>
