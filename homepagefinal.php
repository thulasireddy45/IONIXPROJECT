...
<b><h1 align=center>ONLINE BOOKING PORTAL</h1></b>
  <form  action="payment.php" class="container">
    ...
    <label for="psw"><b color="white">DATE OF JOURNEY</b></label>
    <input type="TEXT" id="t1" placeholder="dd/mm/yyyy" name="psw" required>
	
	 <label for="psw1"><b>RETURN DATE</b></label>
    <input type="TEXT" id="t1" placeholder="dd/mm/yyyy" name="psw1" >

	<label>
          <input type="checkbox" checked="checked" name="sameadr">Confirm details
        </label>

    <button type="submit" class="btn">CONFIRM BOOKING & START PAYMENT</button>
  </form>
</div>
</body>
</html>
