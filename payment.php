      ...
      <form action="final.php">
        ...
        <div class="row">
          ...
          <div class="col-50">
            ...
            <input type="text" id="cname" name="cardname" placeholder="ENTER NAME ON THE CARD">
	    ...
	    <div class="col-50">
                <label for="cvv">Offer Code</label>
                <input type="text" id="cvv" name="cvv" placeholder="ENTER OFFER CODE">
              </div>
</div>
            <div class="row">
              <div class="col-50">
        ...
        <label>
          <input type="checkbox"  name="sameadr">Confirm details
        </label>
...
<form action="offers.php" align="center">
<button class="button">VIEW OFFERS</button><br><br>
</form>
